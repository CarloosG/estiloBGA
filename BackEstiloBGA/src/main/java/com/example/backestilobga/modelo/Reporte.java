...
import com.example.backestilobga.modelo.Cita_reporte;
...
public class Reporte {
    ...
    public Reporte(Long reporte_id, Estilista estilista, Date fecha_inicio, Date fecha_fin, int cantidad_citas, BigDecimal total_ingresos, String correoElectronico, LocalDateTime fecha_generado, Set<Cita_reporte> citaReportes) {
